  ...
  return (
    <section className="py-16 md:py-24 px-5 md:px-8 bg-white border-b border-[#E5E5E5]">
      <div className="max-w-4xl mx-auto text-center">
        <div className="inline-flex w-16 h-16 rounded-[2px] bg-[#FAFAFA] border border-[#E5E5E5] items-center justify-center mb-10">
          <Video className="w-8 h-8 text-black" />
        </div>
        <h2 className="text-4xl md:text-5xl lg:text-6xl text-balance font-bold tracking-tight mb-8">
          Scale Your Short-Form Authority.
        </h2>
        <p className="text-xl text-[#666666] mb-12 max-w-2xl mx-auto">
          Stop posting content that gets scrolled past. Partner with us to
          engineer high-retention vertical media.
        </p>
        <a
