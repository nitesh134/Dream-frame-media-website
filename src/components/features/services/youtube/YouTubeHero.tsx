    ...
    <section className="pt-32 pb-24 px-5 md:px-8 md:pt-40 md:pb-32 border-b border-[#E5E5E5] relative overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10 text-center">
        <div className="inline-flex flex-col items-center">
          <div className="flex items-center gap-2 text-[10px] font-bold text-[#666666] tracking-widest mb-8 border border-[#E5E5E5] rounded-[2px] px-3 py-1.5 uppercase bg-[#FAFAFA] shadow-sm">
            <Youtube className="w-3 h-3" /> Long-Form Production
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-balance font-bold tracking-tight mb-8 leading-[1.05] max-w-4xl mx-auto">
            Long-Form Content Built For Retention.
          </h1>
          <p className="text-xl md:text-2xl text-[#666666] mb-12 leading-relaxed max-w-3xl mx-auto">
            Strategic YouTube editing engineered for watch time, authority
            positioning, and audience growth.
          </p>
          <a
